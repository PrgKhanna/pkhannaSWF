...
import com.swf.rules.MaxAllocationFilterRule;

public class MaxAllocationFilterRuleTest {
	...
	public void init() {
		...
		shiftsBO.add(new EngineerShiftBO(e1, Shift.SECOND, new Date()));
	}

	@Test
	public void maxAllocationRuleWithEmptyEngineerBOTest() {
		MaxAllocationFilterRule rule = new MaxAllocationFilterRule();
	...
	@Test
	public void maxAllocationRuleWithEngineerBOAndNoShiftTest() {
		MaxAllocationFilterRule rule = new MaxAllocationFilterRule();
	...
	@Test
	public void maxAllocationRuleTest() {
